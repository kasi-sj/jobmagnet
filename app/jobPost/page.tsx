...
const page = () => {
  ...
  const [ workFromHome , setWorkFromHome] = useState("Relocate");
            ...
            <Card className='w-3/4'>
                ...
                <CardContent className='w-full'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='title' className=' w-full md:w-1/2' placeholder='Eg. Software Engineer' />
                    </div>
                </CardContent>
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        <label htmlFor='title' className='flex gap-2 my-2 mb-4'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <RadioGroup defaultValue="no" onValueChange={(e)=>setWorkFromHome(e)}>
                        ...
                        { workFromHome ==='Relocate' && 
                                <Input id='title' className=' w-full md:w-1/2' placeholder={'Eg. Madurai'} />
                        }
                    </div>
                </CardContent>
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='title' type='date' className=' w-full md:w-1/2' placeholder='"Eg." +new Date().toLocaleDateString()' />
                    </div>
                </CardContent>
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='title' type='number' className=' w-full md:w-1/2' placeholder='Eg. 3' />
                    </div>
                </CardContent>
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='title' type='number' className=' w-full md:w-1/2' placeholder='Eg. 3000' />
                    </div>
                </CardContent>
                <CardContent>
                ...
                <CardContent>
                    <div className="grid gap-2">
                        <Label htmlFor="skills">Who can Apply ?</Label>
                        <div className="flex gap-2">
                            <Input id="who" value={can} type="text" placeholder="Available for Full Time" onChange={(event)=>{setCan(event.target.value)}} />
                ...
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Input id='title' type='number' className=' w-full md:w-1/2' placeholder='Eg. 5' />
                    </div>
                </CardContent>
